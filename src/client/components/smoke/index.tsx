...
export const Smoke = () => {
    return (
      ...
      <mesh position={[-0.5, -0.18, 0.7]} >
      <sphereGeometry args={[0.4, 32, 16 ]} />
      <meshStandardMaterial color="#8f8a8f" />
      </mesh>
      <mesh position={[0, -0.75, 0.7]} >
      <sphereGeometry args={[0.3, 32, 16 ]} />
      <meshStandardMaterial color="#e0d6e0" />
      </mesh>
      <mesh position={[0, -0.75, 1]} >
      <sphereGeometry args={[0.25, 32, 16 ]} />
      <meshStandardMaterial color="#cac7ca" />
      </mesh>
      <mesh position={[0, -0.75, -0.7]} >
      <sphereGeometry args={[0.3, 32, 16 ]} />
      <meshStandardMaterial color="#a59ba5" />
      </mesh>
      <mesh position={[0, -0.75, -1]} >
      <sphereGeometry args={[0.25, 32, 16 ]} />
      <meshStandardMaterial color="#c7bec7" />
      </mesh>
      <mesh position={[-0.7, -0.6, 0.6]} >
      <sphereGeometry args={[0.3, 32, 16 ]} />
      ...
      <sphereGeometry args={[0.355, 32, 16 ]} />
      <meshStandardMaterial color="#9f98a1" />
      </mesh>
      <mesh position={[0.5, -0.6, 0]} >
      <sphereGeometry args={[0.255, 32, 16 ]} />
      <meshStandardMaterial color="#868088" />
      </mesh>
      <mesh position={[-1, -0.6, 0]} >
      <sphereGeometry args={[0.3, 32, 16 ]} />
      <meshStandardMaterial color="#9f98a1" />
